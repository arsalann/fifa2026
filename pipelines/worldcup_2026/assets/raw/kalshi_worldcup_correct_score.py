"""@bruin
name: raw.kalshi_worldcup_correct_score
description: Open Kalshi World Cup correct-score events with nested match score markets.
image: python:3.13
...
URL = "https://external-api.kalshi.com/trade-api/v2/events?series_ticker=KXWCSCORE&status=open&with_nested_markets=true&limit=200"
